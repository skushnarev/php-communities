...
- 19 октября - Ульяновск, [регистрация](https://panda-meetup.ru/ulsk-php-meetup)[трансояция и запись] (https://www.youtube.com/watch?v=yGGfOFkdSs0&feature=youtu.be)
...
- @aitenmedzhidova - соорганизатор геймдев-ивентов, готова помочь другим митапам по организационным вопросам: общение с подрядчиками, поиск площадок, составление сметы, создание страницы события на Таймпаде, создание сайта или страницы ивента на Тильде, организация работы волонтеров и тд
...
### Ростов-на-Дону
#### Готовы поддерживать митапы от компаний
- @adubovskoy, уже делает symfony/drupal-промо стенды на общеайтишных конференциях, делал друпал-подкасты, контрибьютор в сайты drupal.ru/dru.io .

#### Готовы выступать
- @adubovskoy, фуллстэк, в основном рассказываю о Drupal/Symfony, иногда о vuejs/svelte.

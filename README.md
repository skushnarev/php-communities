...
- TBA (онлайн) - Сравниваем возможности PHP и Go на реальных примерах

- TBA (онлайн) - Открытое собеседование на позицию PHP-синьора от каналов PHPyh и PHP-дайджест

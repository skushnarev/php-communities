...
- https://t.me/phpdigest - @prnsk берет мероприятия в дайджест на Хабре без условий, но будет рад ссылке на канал

- https://t.me/phptoday - @NikolasSumrak готов поддерживать митапы информационно в обмен на линк на канал на странице события

- https://t.me/tg_5minphp - @petrmyazin может рассказать про ивент при случае 

- https://t.me/symfoniacs - @hanovruslan не против анонсов в чате, но предупреждай заранее

- https://t.me/iteventsru - @alienna_dmit готова поддерживать митапы информационно в обмен на линк на канал на странице события
...
### Иваново
#### Готовы поддерживать митапы от компаний
- @afinogenovpro - Involta, организует митапы и конференции [events.involta.ru](https://events.involta.ru)

#### Готовы выступать
Тут пока никого нет, но ты можешь [добавить себя/свою компанию](CONTRIBUTING.md)!

#### Независимые организаторы и сообщества
- @afinogenovpro - Руководитель Event-отдела в компании Involta [events.involta.ru](https://events.involta.ru)
...
- @aitenmedzhidova - соорганизатор ивентов по Lua и GameDev в Москве и Казани. Готова помочь PHP-комьюнити по организационным вопросам: общение с подрядчиками, поиск площадок, создание страницы события на Таймпаде или Тильде, анонсирование, организация работы волонтеров и тд.
...
- @pavelpigalev - SuperJob (свои митапы, докладчики, площадка)
...
### Санкт-Петербург
#### Готовы поддерживать митапы от компаний
- @AgafonovG - Devim (поможем найти спикеров, предоставим своих, поможем в организации мероприятий)
